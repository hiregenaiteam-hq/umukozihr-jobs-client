        ...
        <div className="space-y-4">
          ...
          <label className="flex items-center justify-between cursor-pointer">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Receive alerts for new jobs matching your profile
              </p>
            </div>
            <input
              type="checkbox"
              checked={notifications.email_job_matches}
              onChange={(e) =>
                setNotifications({ ...notifications, email_job_matches: e.target.checked })
              }
              className="w-5 h-5 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
            />
          </label>
          ...
          <label className="flex items-center justify-between cursor-pointer">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Get notified when employers send you messages
              </p>
            </div>
            <input
              type="checkbox"
          ...
          <label className="flex items-center justify-between cursor-pointer">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Receive career tips, job market insights, and product updates
              </p>
            </div>
            <input
              type="checkbox"
